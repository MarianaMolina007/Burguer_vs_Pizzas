...
engine=build_engine('/home/fabricio/Documentos/embebidos2/Burguer_vs_Pizzas/f_model_projectBP2.onnx', shape = [1,250,250,3])
...
while(True):
    ...
    out = do_inference(engine, curr_img_res, h_input_1, d_input_1, h_output, d_output, stream, 1, 224, 224)
    ...
    if out [0]< 0.5:
        ...
        print("HAMBURGUER",out)
    #print('\n******************')   
    #print(" FPS: ", 1.0/(time.time()-start_time))
    print('\n******************')  
    counter+=1
    if counter>=1100:
        print('FPS Average:',counter/(time.time()-start_time))
